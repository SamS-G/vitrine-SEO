        ...
        <div class="row">
            @php
                $services = [
                    ...
                    ['title' => 'Pose de parquet et revêtements de sol', 'route' => 'services.depannage-volets', 'image' => 'parquet.webp', 'text' => ' Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus cupiditate, explicabo ipsum magni odio perferendis rerum sunt tenetur. Aliquam dolorum ea, esse et fuga neque odio possimus quas quia voluptatum!'],
                    ['title' => 'Dépannage de volets roulants', 'route' => 'services.depannage-volets', 'image' => 'reparation.webp', 'text' => ' Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus cupiditate, explicabo ipsum magni odio perferendis rerum sunt tenetur. Aliquam dolorum ea, esse et fuga neque odio possimus quas quia voluptatum!'],
                    ['title' => 'Multi Services', 'route' => 'services.depannage-volets', 'image' => 'multi-service.webp', 'text' => ' Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus cupiditate, explicabo ipsum magni odio perferendis rerum sunt tenetur. Aliquam dolorum ea, esse et fuga neque odio possimus quas quia voluptatum!'],
                ];
            @endphp
