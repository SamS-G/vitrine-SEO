        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="brands-logo mx-auto"><img src="{{ Vite::asset('resources/images/brands/castes-logo.webp') }}" class="img-fluid" alt="Castes Industrie"></div>
                    <div class="card-body">
                    ...
                    <div class="card-footer text-center">
                        <a href="https://www.castes-industrie.fr" class="btn btn-primary cta-button" target="_blank">Visiter le site</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-footer text-center">
                        <a href="https://www.amb-france.com" class="btn btn-primary cta-button" target="_blank">Visiter le site</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-footer text-center">
                        <a href="https://www.lakal.de" class="btn btn-primary cta-button" target="_blank">Visiter le site</a>
                    </div>
                </div>
            </div>
        </div>
