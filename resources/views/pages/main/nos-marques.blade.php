        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-footer text-center">
                        <a href="https://www.castes-industrie.fr" class="btn button service-button" target="_blank"><i class="fa-solid fa-at"></i> Visiter le site</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-footer text-center">
                        <a href="https://www.amb-france.com" class="btn button service-button" target="_blank"><i class="fa-solid fa-at"></i> Visiter le site</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-footer text-center">
                        <a href="https://www.lakal.de" class="btn button service-button" target="_blank"><i class="fa-solid fa-at "></i> Visiter le site</a>
                    </div>
                </div>
            </div>
        </div>
