<div class="col-10 mx-auto py-5">
    {{-- Titre du service --}}
    <h1 class="text-center mb-4 services-title">{{ $title }}</h1>
    ...
    <div class="gallery mb-5">
        <h2 class="text-center mb-4 services-title">Exemple avant / après</h2>
        <div class="row">
    ...
    {{-- Section FAQ --}}
    <div class="faq mb-5">
        <h2 class="text-center mb-4 services-title">Foire aux questions</h2>
